...
Our first research question is exploratory in nature, whereas our third research question is experimental.

1. What pitch accents do L1 General American English L2 Spanish learners use for requests in Spanish?

Based on @astruc2016intonational, we expect there to be L1-L2 transfer of pitch contours, such that L1 English pitch contours will be used in the L2 Spanish.
